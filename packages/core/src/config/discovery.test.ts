...
describe('findConfigPath', () => {
  ...
  it('should log discovery process when logger provided', () => {
    ...
    expect(debugSpy).toHaveBeenCalledWith('Starting config search from:', expect.any(String));
    expect(infoSpy).toHaveBeenCalledWith('Found config file:', expect.any(String));
  });
