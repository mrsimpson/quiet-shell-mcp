...
import { executeCommand, TemplateManager, BUILTIN_TEMPLATES } from '@codemcp/quiet-shell-core';
...
describe('MCP Server Integration', () => {
  ...
  describe('Template Error Messages', () => {
    it('should generate error message with list_templates instruction', () => {
      ...
      const templateManager = new TemplateManager();
      const availableTemplates = Object.keys(templateManager.getAvailableTemplates()).join(', ');
      ...
      expect(errorMessage).toContain('Template "nonexistent-template" not found');
